...
pub mod quantum {
    const _: () = {
        ::core::include_bytes!(
            "/Users/adityabansal/workspace/electron/repo/quantum-node/quantum_contract/src/abi/Quantum.json",
        );
    };
    #[allow(deprecated)]
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions: ::core::convert::From::from([
                        ...
                        ::ethers::core::abi::ethabi::Function {
                            ...
                            inputs: ::std::vec![
                                ::ethers::core::abi::ethabi::Param {
                                    name: ::std::borrow::ToOwned::to_owned("initState"),
                ...
                (
                    ::std::borrow::ToOwned::to_owned("updateQuantumState"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            name: ::std::borrow::ToOwned::to_owned("updateQuantumState"),
                            inputs: ::std::vec![
                                ::ethers::core::abi::ethabi::Param {
    ...
    impl<M: ::ethers::providers::Middleware> Quantum<M> {
        ...
        pub fn initialize(
            ...
            self.0
                .method_hash([148, 152, 189, 113], init_state)
        ...
        pub fn state(&self) -> ::ethers::contract::builders::ContractCall<M, [u8; 32]> {
            self.0
                .method_hash([193, 157, 147, 251], ())
                .expect("method not found (this should never happen)")
        }
        ///Calls the contract's `updateQuantumState` (0x709666d0) function
        pub fn update_quantum_state(
            ...
            self.0
                .method_hash([112, 150, 102, 208], (new_state, proof))
                .expect("method not found (this should never happen)")
        }
    ...
    ///Container type for all input parameters for the `updateQuantumState` function with signature `updateQuantumState(bytes32,(uint256[8],uint256[2],uint256[2]))` and selector `0x709666d0`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(
        ...
        abi = "updateQuantumState(bytes32,(uint256[8],uint256[2],uint256[2]))"
    )]
    pub struct UpdateQuantumStateCall {
        pub new_state: [u8; 32],
        pub proof: Proof,
    }
    ...
    pub enum QuantumCalls {
        ...
        Owner(OwnerCall),
        State(StateCall),
        UpdateQuantumState(UpdateQuantumStateCall),
    ...
    impl ::ethers::core::abi::AbiDecode for QuantumCalls {
        fn decode(
            ...
            if let Ok(decoded) = <UpdateQuantumStateCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::UpdateQuantumState(decoded));
            }
    ...
    impl ::ethers::core::abi::AbiEncode for QuantumCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::UpdateQuantumState(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
    ...
    impl ::core::convert::From<StateCall> for QuantumCalls {
        fn from(value: StateCall) -> Self {
            Self::State(value)
        }
    }
    impl ::core::convert::From<UpdateQuantumStateCall> for QuantumCalls {
        fn from(value: UpdateQuantumStateCall) -> Self {
            Self::UpdateQuantumState(value)
        }
    }
    impl ::core::convert::From<UpdateVerifierCall> for QuantumCalls {
    ...
    pub struct StateReturn(pub [u8; 32]);
