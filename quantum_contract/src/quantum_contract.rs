...
pub mod quantum {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions: ::core::convert::From::from([
                ...
                (
                    ::std::borrow::ToOwned::to_owned("aggVKey"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            name: ::std::borrow::ToOwned::to_owned("aggVKey"),
                            inputs: ::std::vec![],
                            outputs: ::std::vec![
                                ::ethers::core::abi::ethabi::Param {
                                    name: ::std::string::String::new(),
                    ...
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            ...
                            inputs: ::std::vec![
                                ...
                                ::ethers::core::abi::ethabi::Param {
                                    name: ::std::borrow::ToOwned::to_owned("aggVKey_"),
                                    kind: ::ethers::core::abi::ethabi::ParamType::FixedBytes(
                                        32usize,
                                    ),
                                    internal_type: ::core::option::Option::Some(
                ...
                (
                    ::std::borrow::ToOwned::to_owned("setAggVKey"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            name: ::std::borrow::ToOwned::to_owned("setAggVKey"),
                            inputs: ::std::vec![
                                ::ethers::core::abi::ethabi::Param {
                                    name: ::std::borrow::ToOwned::to_owned("aggVKey_"),
                                    kind: ::ethers::core::abi::ethabi::ParamType::FixedBytes(
                    ...
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            ...
                            inputs: ::std::vec![
                                ...
                                ::ethers::core::abi::ethabi::Param {
                                    name: ::std::borrow::ToOwned::to_owned("superRoot"),
                                    kind: ::ethers::core::abi::ethabi::ParamType::FixedBytes(
                                        32usize,
                                    ),
                                    internal_type: ::core::option::Option::Some(
    ...
    impl<M: ::ethers::providers::Middleware> Quantum<M> {
        ...
        ///Calls the contract's `aggVKey` (0x742694a3) function
        pub fn agg_v_key(
            &self,
        ) -> ::ethers::contract::builders::ContractCall<M, [u8; 32]> {
            self.0
                .method_hash([116, 38, 148, 163], ())
                .expect("method not found (this should never happen)")
        }
        ...
        pub fn initialize(
            ...
            self.0
                .method_hash([190, 19, 244, 124], (verifier, agg_v_key))
                .expect("method not found (this should never happen)")
        }
        ...
        ///Calls the contract's `setAggVKey` (0x0f5797a0) function
        pub fn set_agg_v_key(
            &self,
            agg_v_key: [u8; 32],
        ) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, QuantumEvents> {
    ...
    impl ::ethers::core::abi::AbiDecode for QuantumErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for QuantumErrors {
    ...
    impl ::ethers::contract::ContractRevert for QuantumErrors {
    ...
    impl ::core::fmt::Display for QuantumErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<::std::string::String> for QuantumErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<AddressEmptyCode> for QuantumErrors {
        fn from(value: AddressEmptyCode) -> Self {
            Self::AddressEmptyCode(value)
        }
    }
    impl ::core::convert::From<ERC1967InvalidImplementation> for QuantumErrors {
        fn from(value: ERC1967InvalidImplementation) -> Self {
            Self::ERC1967InvalidImplementation(value)
        }
    }
    impl ::core::convert::From<ERC1967NonPayable> for QuantumErrors {
    ...
    impl ::core::convert::From<NotInitializing> for QuantumErrors {
        fn from(value: NotInitializing) -> Self {
            Self::NotInitializing(value)
        }
    }
    impl ::core::convert::From<OwnableInvalidOwner> for QuantumErrors {
        fn from(value: OwnableInvalidOwner) -> Self {
            Self::OwnableInvalidOwner(value)
        }
    }
    impl ::core::convert::From<OwnableUnauthorizedAccount> for QuantumErrors {
        fn from(value: OwnableUnauthorizedAccount) -> Self {
            Self::OwnableUnauthorizedAccount(value)
        }
    }
    impl ::core::convert::From<UUPSUnauthorizedCallContext> for QuantumErrors {
        fn from(value: UUPSUnauthorizedCallContext) -> Self {
            Self::UUPSUnauthorizedCallContext(value)
        }
    }
    impl ::core::convert::From<UUPSUnsupportedProxiableUUID> for QuantumErrors {
    ...
    #[derive(Clone, ::ethers::contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum QuantumEvents {
        InitializedFilter(InitializedFilter),
        OwnershipTransferredFilter(OwnershipTransferredFilter),
        UpgradedFilter(UpgradedFilter),
    }
    impl ::ethers::contract::EthLogDecode for QuantumEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = InitializedFilter::decode_log(log) {
                return Ok(QuantumEvents::InitializedFilter(decoded));
            }
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(QuantumEvents::OwnershipTransferredFilter(decoded));
            }
            if let Ok(decoded) = UpgradedFilter::decode_log(log) {
                return Ok(QuantumEvents::UpgradedFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for QuantumEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<InitializedFilter> for QuantumEvents {
        fn from(value: InitializedFilter) -> Self {
            Self::InitializedFilter(value)
        }
    }
    impl ::core::convert::From<OwnershipTransferredFilter> for QuantumEvents {
        fn from(value: OwnershipTransferredFilter) -> Self {
            Self::OwnershipTransferredFilter(value)
        }
    }
    impl ::core::convert::From<UpgradedFilter> for QuantumEvents {
    ...
    ///Container type for all input parameters for the `aggVKey` function with signature `aggVKey()` and selector `0x742694a3`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(name = "aggVKey", abi = "aggVKey()")]
    pub struct AggVKeyCall;
    ...
    ///Container type for all input parameters for the `setAggVKey` function with signature `setAggVKey(bytes32)` and selector `0x0f5797a0`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(name = "setAggVKey", abi = "setAggVKey(bytes32)")]
    ...
    impl ::ethers::core::abi::AbiDecode for QuantumCalls {
        fn decode(
            ...
            if let Ok(decoded) = <AggVKeyCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::AggVKey(decoded));
            }
            ...
            if let Ok(decoded) = <SetAggVKeyCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
    ...
    impl ::ethers::core::abi::AbiEncode for QuantumCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::AggVKey(element) => ::ethers::core::abi::AbiEncode::encode(element),
    ...
    impl ::core::fmt::Display for QuantumCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::AggVKey(element) => ::core::fmt::Display::fmt(element, f),
    ...
    impl ::core::convert::From<UpgradeInterfaceVersionCall> for QuantumCalls {
        fn from(value: UpgradeInterfaceVersionCall) -> Self {
            Self::UpgradeInterfaceVersion(value)
        }
    }
    impl ::core::convert::From<AggVKeyCall> for QuantumCalls {
        fn from(value: AggVKeyCall) -> Self {
            Self::AggVKey(value)
        }
    }
    impl ::core::convert::From<InitializeCall> for QuantumCalls {
    ...
    impl ::core::convert::From<ProxiableUUIDCall> for QuantumCalls {
        fn from(value: ProxiableUUIDCall) -> Self {
            Self::ProxiableUUID(value)
        }
    }
    impl ::core::convert::From<RenounceOwnershipCall> for QuantumCalls {
    ...
    impl ::core::convert::From<TransferOwnershipCall> for QuantumCalls {
        fn from(value: TransferOwnershipCall) -> Self {
            Self::TransferOwnership(value)
        }
    }
    impl ::core::convert::From<UpgradeToAndCallCall> for QuantumCalls {
    ...
    ///Container type for all return fields from the `aggVKey` function with signature `aggVKey()` and selector `0x742694a3`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    pub struct AggVKeyReturn(pub [u8; 32]);
